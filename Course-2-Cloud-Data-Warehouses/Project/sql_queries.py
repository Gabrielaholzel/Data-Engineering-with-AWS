...
staging_events_table_create= ("""CREATE TABLE IF NOT EXISTS staging_events (
    ...
    page            VARCHAR,
    registration    FLOAT,
    sessionId       INT PRIMARY KEY DISTKEY,
...
insert_table_queries = [songplay_table_insert, user_table_insert, song_table_insert, artist_table_insert, time_table_insert, "VACUUM;", "ANALYZE;"]
